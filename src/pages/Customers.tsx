      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        {customers.map((c) => (
          <div key={c.id} className="bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition overflow-hidden flex">
            ...
            <div className="relative w-28 sm:w-36 flex-shrink-0 bg-gradient-to-br from-primary-50 to-blue-50">
              {c.photo ? (
            ...
            <div className="flex-1 p-3 flex flex-col justify-between min-w-0">
              ...
              <div className="flex gap-1 mt-2">
                ...
                <button onClick={() => openEditForm(c)} className="px-2.5 py-1.5 rounded bg-blue-50 text-blue-700 hover:bg-blue-100 transition"><Edit2 className="w-3.5 h-3.5" /></button>
